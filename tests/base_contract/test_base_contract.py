...
mocked_web3 = 'src.base_contract.Web3'


@patch.dict(artifacts_dict, mock_abi, clear=True)
@patch(mocked_web3, autospec=True)
class TestInit:
    ...
    def test_name_without_arg(self, mock_Web3):
        ...
        with pytest.raises(KeyError):
            instance = base_contract.BaseContract(artifact_name='', web3=w3)
            assert instance
    ...
    def test_assigned_network_ids(self, mock_Web3, input):
        ...
        w3 = mock_Web3()
        w3.eth.contract.return_value = w3._utils.datatypes.Contract
        instance = base_contract.BaseContract(artifact_name='TEST_ARTIFACT', network_id=input, web3=w3)
    ...
    def test_network_id_should_fail_if_given_unknown_id(self, mock_Web3, wrong_net_id):
        ...
        with pytest.raises(KeyError):
            instance = base_contract.BaseContract(artifact_name='TEST_ARTIFACT', network_id=wrong_net_id, web3=w3)
            assert instance
    ...
    def test_network_id_of_zero(self, mock_Web3):
        ...
        instance = base_contract.BaseContract(artifact_name='TEST_ARTIFACT', network_id=0, web3=w3)
...
@patch.dict(artifacts_dict, mock_abi, clear=True)
@patch(mocked_web3, autospec=False)
class TestAddress:
    ...
    def test_address_argument(self, mock_Web3):
        ...
        instance = base_contract.BaseContract(artifact_name='TEST_ARTIFACT', address='0x_some_address', web3=w3)
    ...
    def test_address_with_no_argument(self, mock_Web3, network_input, address_output):
        ...
        instance = base_contract.BaseContract(artifact_name='TEST_ARTIFACT', network_id=network_input, web3=w3)
...
class TestArtifactsDirectory:
    ...
    def test_artifact_instance_from_artifacts_directory_arg(self, mock_utils_abi, mock_artifact_dir, mock_Web3,
        ...
        instance = base_contract.BaseContract(artifact_name=art_input, artifacts_dir='some/path/',
                                              network_id=net_id_input, web3=w3)
...
class TestContracts:
    ...
    def test_coordinator_contract_without_coordinator_address_provided(self, mock_Web3, input_id, expected_output):
        ...
        instance = base_contract.BaseContract(artifact_name='TEST_ARTIFACT', network_id=input_id, web3=w3)
    ...
    def test_contract_instance_with_coor_through_get_contract_method(self, mock_get_contract, mock_Web3):
        ...
        instance = base_contract.BaseContract(artifact_name='TEST_ARTIFACT', coordinator=test_address, web3=w3)
...
class TestMethods:
    ...
    def test_sync_get_contract(self, mock_async_get_contract, mock_Web3):
        ...
        instance = base_contract.BaseContract(artifact_name='TEST_ARTIFACT', coordinator='some_address', web3=w3)
...
class TestAsyncs:
    ...
    async def get_contract_owner(self, mock_Web3):
        mock_Web3.return_value = MagicMock()
        w3 = mock_Web3()
        w3.eth.contract.side_effect = self.capture_args
        w3.toChecksumAddress.side_effect = self.capture_args
...
#    @pytest.mark.anyio
#    async def test_get_contract_owner_type(self, mock_Web3):
#        mock_Web3.return_value = MagicMock()
#        w3 = mock_Web3()
#        w3.eth.contract.side_effect = self.capture_args
#        w3.toChecksumAddress.side_effect = self.capture_args
